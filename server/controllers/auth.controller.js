...
export const signin = async (req, res, next) => {
  ...
  try {
    ...
    if (!validUser) return next(errorHandler(404, "Email belum terdaftar"));
...
export const signout = (req, res) => {
  res.clearCookie("access_token").status(200).json("Logout Berhasil");
};
...
export const createAdmin = async (req, res, next) => {
  try {
    ...
    //3 Buat UserBaru dengan role 'Admin'
